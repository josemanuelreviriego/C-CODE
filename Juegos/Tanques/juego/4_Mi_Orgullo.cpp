...
void dibujo_tanque2(){
		...
		mvprintw(20.5,184.5, ARMA2); //(19.5,)  	
		mvprintw(21.5,185.5, ARMA2); //(19.5,) 

		//Cuerpo

		mvprintw(22.5,186.5, CUERPO); //(19.5,) 
		mvprintw(23.5,186.5, CUERPO); //(19.5,) B
		mvprintw(23.5,187.5, CUERPO); //(19.5,) C
		mvprintw(23.5,185.5, CUERPO); //(19.5,) A
		
		mvprintw(24.5,186.5, CUERPO); //(19.5,) B3
		mvprintw(24.5,187.5, CUERPO); //(19.5,) C3
		mvprintw(24.5,185.5, CUERPO); //(19.5,) A3

		mvprintw(24.5,184.5, CUERPO); //(19.5,) IZQ
		mvprintw(24.5,188.5, CUERPO); //(19.5,) DER
		
		mvprintw(25.5,188.5, RUEDAS); //(19.5,) C4
		mvprintw(25.5,185.5, "·"); //(19.5,) A4
...
void texto(int *ammo,int *ammo2){
	...
	//SALIR
	mvprintw(3.5,85.5, "Pulsa Esc para salir");
	...
	//J2
	mvprintw(11.5,170., "Pulsa \"l\" para disparar");
	mvprintw(10.5,170, "Te quedan %i balas ",*ammo2);
